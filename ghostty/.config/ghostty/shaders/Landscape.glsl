...
void mainImage(out vec4 frag_col, in vec2 frag_coord) {
    ...
    coord.y = -coord.y;  // Only flip the shader coordinate space
    float z = (iTime * 1.0);
    ...
    float blendFactor = 0.5 * (1.0 - textPresence * 0.7);
    frag_col = vec4(mix(terminalColor.rgb, col, blendFactor), terminalColor.a);
}
